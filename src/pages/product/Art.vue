      ...
      <row>
        <column col="12">
          <BreadCrumb :pages="
            ...
            {name:'Collections',link:{name:'ALL_COLLECTION'}},
            {name:route.hash.slice(1).split('-').join(' '),link:{name:'COLLECTION_LIST',params:{name:route.hash.slice(1)}}},
...
<!--      <<<<<<<<< description row >>>>>>>>>-->
      <row class="!my-3 !items-center">
        ...
        <column col="12" sm="6">
          <div>
            <img
                v-lazy="'//cdn.shopify.com/s/files/1/0272/9548/1943/files/brentos-prints2.jpg?v=1663739542&width=480'"
                alt=""
      ...
      <row class="!my-3 !items-center">
        <column col="12" sm="6">
          <div>
            <img
                v-lazy="'//cdn.shopify.com/s/files/1/0272/9548/1943/files/brentos-prints4.jpg?v=1663739487&width=480'"
                alt=""
      ...
      <row class="!my-3 !items-center">
        ...
        <column col="12" sm="6">
          <div>
            <img
                v-lazy="'//cdn.shopify.com/s/files/1/0272/9548/1943/files/brentos-frame1.jpg?v=1663740555&width=480'"
                alt=""
    ...
    <container-full>
      <row class="!p-0 !m-0">
        <column col="12" sm="6" class="!p-0 !m-0">
          <img
              v-lazy="'//cdn.shopify.com/s/files/1/0272/9548/1943/files/6b.jpg?v=1663388526&width=480'"
      ...
      <row>
        <column col="12">
          <div class="border-[1px] border-gray-300/80 rounded-8 overflow-hidden">
            <FaqItem v-for="item in faqData" :title="item.title" :description="item.description"/>
          </div>
        </column>
      </row>
    </container>
