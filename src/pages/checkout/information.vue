      ...
      <row class="!m-0 !p-0">
        <column class="lg:!pt-3 lg:!px-4 pt-1 px-1 !m-0" lg="7" col="12">
          ...
          <main>
            ...
            <FloatInput  v-model="contactInfo" placeholder="Email or mobile phone number"/>
            ...
            <template v-else>
              <p class="text-0.8 text-gray-600 font-400 mt-0.5">
                ...
                <button class="!text-dark">Privacy policy</button> and
                <button class="!text-dark">Terms of service.</button>
              </p>
            </template>
            <h5 class="!font-500 mt-2.5 mb-1.5">Shipping address </h5>
            <SelectBox class="!my-1" label="Country/Region" v-model="country" :option="['United State','Iran','Germany','Spain']"/>
            <row class="!p-0 !m-0">
              <column class="sm:pr-1" col="12" sm="6">
                <FloatInput  v-model="firstname" placeholder="First name"/>
              </column>
              <column col="12" sm="6">
                <FloatInput  v-model="lastname" placeholder="Last name"/>
              </column>
            </row>
            <row class="!p-0 !m-0">
              <column col="12" >
                <FloatInput  v-model="address" placeholder="Address"/>
              </column>
            </row>
            <row class="!p-0 !m-0">
              <column col="12" >
            ...
            <row class="!p-0 !m-0">
              <column  class="sm:pr-0.5"  col="12" sm="4" >
                <FloatInput  v-model="city" placeholder="City"/>
              </column>
              <column class="sm:pr-0.5" col="12" sm="4" >
                <SelectBox select-class="!pt-1.1" label="State" v-model="state" :option="['United State','Iran','Germany','Spain']"/>
              </column>
              <column  col="12" sm="4" >
                <FloatInput  v-model="zip" placeholder="Zip code"/>
              </column>
            </row>
