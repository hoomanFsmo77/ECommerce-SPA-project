        ...
        <div class="border-[1px] border-gray-400 px-0.5 mb-1.5 md:mb-0">
            <row>
              ...
              <column col="6" md="4" class="mb-0.7">
                ...
                <span class="font-400 ml-0.5">{{allInformation?.contact?.firstname?.value}} {{allInformation?.contact?.lastname?.value}}</span>
              </column>
              <column col="6" md="4" class="mb-0.7">
              ...
              <column col="6" md="4" class="mb-0.7">
                ...
                <span class="font-400 ml-0.5">{{cookieId}}</span>
              </column>
            </row>
        </div>
      </column>
        ...
        <div class="border-[1px] border-gray-400 px-0.5 mb-1.5 md:mb-0">
          <row>
            ...
            <column col="12"  class="mb-0.7">
              ...
              <span class="font-400 ml-0.5">{{allInformation?.contact?.contactInfo?.value}}</span>
            </column>
          </row>
        </div>
      </column>
...
<script setup>
import {useCheckoutSummary} from "../../composables/useCheckoutSummary.js";
const {allInformation,calculateShippingAddress,cookieId,cartList,totalPrice}=useCheckoutSummary()
</script>
